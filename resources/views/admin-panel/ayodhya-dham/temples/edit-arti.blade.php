...
<section class="content">
    <div class="">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Arti</li>
                    </ul>
        ...
        <div class="container-fluid">
            <form  action="{{route('adminArtiUpdate')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row" >
                    <div class="col-lg-12 col-md-12">
                        <input type="hidden" name="id" value="{{$artiDetail->id}}">
                        ...
                        <div class="form-group">                                
                            <select name="temple_id" class="form-control" id="temple_id" required>
                                ...
                                @foreach ($ayodhyaDhamTemple as $temple)
                                    <option value="{{ $temple->id }}" {{ $artiDetail->temple_id == $temple->id ? 'selected' : '' }}>
                                        {{ $temple->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="form-group">                                
                            <input type="text" id="arti_name" name="arti_name" class="form-control" placeholder="Arti Name" value="{{$artiDetail->arti_name}}" required>
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="form-group">                                
                            <input type="text" id="arti_time" name="arti_time" class="form-control" placeholder="Arti Time" value="{{$artiDetail->arti_time}}" required>
