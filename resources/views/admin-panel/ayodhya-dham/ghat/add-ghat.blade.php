...
<section class="content">
    <div class="">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Ayodhya Dham Ghat Add</li>
                    </ul>
        ...
        <div class="container-fluid">
            <form  action="{{route('adminAyodhyaDhamGhatSave')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row" >
                    <div class="row">
