        ...
        <div class="block-header">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <a href="{{route('adminBankAdd')}}" ><button class="btn btn-primary float-right">Add Bank</button></a>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#users-table').on('click', '.bank-status', function() {
            var button = $(this);
            var banklId = button.data('id');
            ...
            if (confirm(confirmationMessage)) {
                $.ajax({
                url: '{{ route('adminBankUpdateStatus') }}',
                type: 'POST',
                headers: {
