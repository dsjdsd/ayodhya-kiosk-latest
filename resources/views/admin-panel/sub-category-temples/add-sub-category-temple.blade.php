...
<section class="content">
    <div class="">
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>{{$temples_category_detail->name}}</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('adminDashboard')}}"><i class="zmdi zmdi-home"></i> Dashboard</a></li>
                        <li class="breadcrumb-item active">{{$temples_category_detail->name}}</li>
                    </ul>
        ...
        <div class="container-fluid">
            <form  action="{{route('adminSubCategoryTempleSave')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row" >
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="form-group">                                
                        <input type="hidden" id="temple_category_id" name="temple_category_id" class="form-control"  value="{{$temples_category_detail->id}}" required>
