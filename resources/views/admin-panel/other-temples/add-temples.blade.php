...
<section class="content">
    <div class="">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Other Famous Places Add</li>
                    </ul>
        ...
        <div class="container-fluid">
            <form  action="{{route('adminTempleSave')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row" >
